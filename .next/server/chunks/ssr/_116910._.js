...
const HighchartsDrilldownMap = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchMapData = async ()=>{
            const nordicTopology = await fetch("https://code.highcharts.com/mapdata/custom/nordic-countries-core.topo.json").then((response)=>response.json());
            const topologies = {};
            for (const geometry of nordicTopology.objects.default.geometries){
                const key = geometry.properties["hc-key"];
                topologies[key] = await fetch(`https://code.highcharts.com/mapdata/countries/${key}/${key}-all.topo.json`).then((response)=>response.json());
            }
            setOptions({
                chart: {
                    map: nordicTopology
