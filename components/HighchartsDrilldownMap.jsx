    ...
    const fetchMapData = async () => {
      ...
      for (const geometry of nordicTopology.objects.default.geometries) {
        ...
        topologies[key] = await fetch(
          `https://code.highcharts.com/mapdata/countries/${key}/${key}-all.topo.json`
        ).then((response) => response.json());
      }
        ...
        series: [
          {
            ...
            showInLegend: false,
            data: [
              { "hc-key": "no", value: 15, drilldown: "norway" },
              { "hc-key": "is", value: 14, drilldown: "iceland" },
              { "hc-key": "fo", value: 13, drilldown: "faroe-islands" },
              { "hc-key": "fi", value: 12, drilldown: "finland" },
              { "hc-key": "se", value: 11, drilldown: "sweden" },
              { "hc-key": "dk", value: 10, drilldown: "denmark" },
            ],
          },
        ],
        drilldown: {
